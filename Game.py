...
class Background(Mode):
    def __init__(self, app):
        ...
        self.setRocks()
        self.setRiver()
        url = 'https://raw.githubusercontent.com/Yuhang-Liang/15-112-Homework9/master/222.png'
    ...
    #     drawBricks(self,canvas)
    #     drawRiver(self,canvas)
    #     drawGrass(self,canvas)
    #     drawRock(self,canvas)
    #     drawCamp(self,canvas)
...
class GameMode(Mode):
    ...
    def redrawAll(mode, canvas):
        ...
        # mode.background.drawRock(canvas)
